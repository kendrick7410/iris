...
commas, colons, parentheses, or split into two sentences. This applies to the
heading, the paragraph, and any internal punctuation. Self-check for any
U+2014 character in the output before returning the draft, and remove it.
